                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="/#">
                                <img src="/images/icon/tutorapp2.png" alt="{{config('app.name')}}">
                            </a>
                        </div>
                        <x-alert-message />
                        <div class="login-form">
                            <form action="{{route('register')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="first_name" placeholder=" First Name" value="{{old('first_name')}}">
                                    <x-error-message name="first_name"/>
                                </div>
                                <div class="form-group">
                                    <label>Middle Name</label>
                                    <input class="au-input au-input--full" type="text" name="middle_name" placeholder="Middle Name" value="{{old('middle_name')}}">
                                    <x-error-message name="middle_name"/>
                                </div>
                                <div class="form-group">
                                    <label>Last Name</label>
                                    <input class="au-input au-input--full" type="text" name="last_name" placeholder="Last Name" value="{{old('last_name')}}">
