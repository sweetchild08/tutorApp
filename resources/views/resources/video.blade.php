        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 p-4">
                ...
                <div class="file-loading">
                    ...
                    <input type="file" id="input-ficons-5" name="videos[]" accept="video/*" multiple>
                </div>
                        ...
                        <tbody>
                            @forelse ($videos as $video)
                                <tr>
                                    ...
                                    <td class="process">{{$video->status}}</td>
                                    <td></td>
                                    <td>
                                        <div class="table-data-feature">
                                            ...
                                            <button class="item del" data-toggle="tooltip" data-placement="top" title="Delete" data-videoid="{{$video->id}}">
...
$("#input-ficons-5").fileinput({
    uploadUrl: "{{route('teacher.video.store')}}",
    // uploadAsync:false,
    showUpload: false,
    uploadExtraData: {
    ...
    previewFileIconSettings: {
      ...
      mp3: '<i class="far fa-file-video text-warning"></i>',
...
$('.del').click(function(e){
    ...
    let url='{{route('teacher.video.destroy',':id')}}';
